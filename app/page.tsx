      ...
      <section className="relative overflow-hidden pt-20 pb-32">
        ...
        <div className="relative container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <Link
              href={user ? "/dashboard" : "/signup"}
              className="bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 text-primary-foreground px-8 py-4 rounded-xl text-lg font-bold shadow-lg hover:shadow-primary/50 hover:scale-105 transition-all duration-300 inline-flex items-center justify-center gap-2"
            >
              {user ? "Go to Dashboard" : "Get Started Free"}
              <ArrowRight className="w-5 h-5" />
            </Link>
            <Link
              href="/features"
              className="glass-panel px-8 py-4 rounded-xl text-lg font-semibold hover:shadow-[0_0_30px_-5px_var(--color-primary)] hover:border-primary/30 transition-all duration-300 inline-flex items-center justify-center gap-2"
            >
              <BookOpen className="w-5 h-5" />
              Explore Features
            </Link>
      ...
      <section className="py-20 bg-gradient-to-b from-background via-card/30 to-background">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Smart Planner Card */}
            <Link href={user ? "/dashboard" : "/login"} className="group">
              <div className="glass-panel p-8 rounded-2xl border border-border hover:border-primary/30 hover:shadow-[0_0_30px_-5px_var(--color-primary)] transition-all duration-300 h-full">
            ...
            {/* AI Oral Tutor Card */}
            <Link href={user ? "/oral-practice" : "/login"} className="group">
              <div className="glass-panel p-8 rounded-2xl border border-border hover:border-secondary/30 hover:shadow-[0_0_30px_-5px_var(--color-secondary)] transition-all duration-300 h-full relative overflow-hidden">
                <div className="absolute top-4 right-4 bg-gradient-to-r from-secondary to-accent text-primary-foreground text-xs font-bold px-3 py-1.5 rounded-full">
                  MOST POPULAR
                </div>
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-secondary/10 mb-6 group-hover:scale-110 transition-transform">
                  <MessageSquare className="w-7 h-7 text-secondary" />
                </div>
                <div className="flex items-center gap-3 mb-4">
                  <Zap className="w-5 h-5 text-accent" />
                  <h3 className="text-xl font-bold text-foreground">AI Oral Tutor</h3>
                </div>
                <p className="text-muted-foreground mb-6">
                  Practice Hindi, Marathi & English with real-time AI feedback. Perfect your pronunciation and fluency.
                </p>
            ...
            <div className="glass-panel p-8 rounded-2xl border border-border hover:border-accent/30 transition-all duration-300 h-full relative">
              ...
              <div className="flex items-center gap-3 mb-4">
                <BarChart className="w-5 h-5 text-accent" />
                <h3 className="text-xl font-bold text-foreground">Test Generator</h3>
              </div>
              <p className="text-muted-foreground mb-6">
                Turn your textbooks into instant MCQ quizzes. Automated test generation powered by advanced AI.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            <div className="glass-panel p-8 rounded-2xl">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-bold mb-3 text-foreground">Buy Learning Time</h3>
                <p className="text-muted-foreground">
                  Get premium access to all features with flexible subscription plans tailored for students.
                </p>
              </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="flex items-center justify-between p-4 rounded-lg bg-muted/50">
                    <div>
                      <div className="font-bold text-foreground">{plan.plan}</div>
                      <div className="text-sm text-muted-foreground">{plan.features}</div>
                    </div>
      ...
      <section className="py-20 bg-gradient-to-b from-background via-card/30 to-background">
        <div className="container mx-auto px-6">
          ...
          <div className="glass-panel p-8 rounded-2xl max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-2xl font-bold mb-6 text-foreground">Start Your Journey</h3>
                <p className="text-muted-foreground mb-8">
                  Join thousands of students who have transformed their learning experience with AI-powered tools.
                </p>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    <div key={idx} className="flex items-start gap-4">
                      <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-br from-primary to-secondary text-primary-foreground font-bold">
                        {step.step}
                      </div>
                      <div>
                        <h4 className="font-bold mb-1 text-foreground">{step.title}</h4>
                        <p className="text-sm text-muted-foreground">{step.desc}</p>
                      </div>
                    </div>
                  ))}
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-3 rounded-xl bg-muted/50 border border-border text-foreground placeholder:text-muted-foreground focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 transition-colors"
                    placeholder="Enter your full name"
                  />
                </div>
                <div>
                ...
                <div>
                  <label className="block text-sm font-semibold mb-2 text-foreground">Grade Level</label>
                  <select className="w-full px-4 py-3 rounded-xl bg-muted/50 border border-border text-foreground focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 transition-colors">
                    <option className="bg-background">Select your grade</option>
                    <option className="bg-background">6th - 8th Grade</option>
                    <option className="bg-background">9th - 10th Grade</option>
                    <option className="bg-background">11th - 12th Grade</option>
                    <option className="bg-background">College/University</option>
                  </select>
                </div>
                <button className="bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 text-primary-foreground w-full py-4 rounded-xl text-lg font-bold hover:scale-[1.02] transition-all duration-300">
                  Start Learning Free
                </button>
              </div>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <div key={idx} className="glass-panel p-8 rounded-2xl hover:shadow-[0_0_30px_-5px_var(--color-primary)] hover:border-primary/30 transition-all duration-300">
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="glass-panel rounded-2xl p-12 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href={user ? "/dashboard" : "/signup"}
                className="bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 text-primary-foreground px-10 py-5 rounded-xl text-lg font-bold shadow-lg hover:shadow-primary/50 hover:scale-105 transition-all duration-300 inline-flex items-center justify-center gap-3"
              >
                {user ? "Go to Dashboard" : "Start Free Trial"}
                <ArrowRight className="w-6 h-6" />
              </Link>
              <Link
                href="/demo"
                className="glass-panel px-10 py-5 rounded-xl text-lg font-semibold hover:shadow-[0_0_30px_-5px_var(--color-primary)] hover:border-primary/30 transition-all duration-300 inline-flex items-center justify-center gap-3"
              >
                <Sparkles className="w-5 h-5" />
                Watch Demo
              </Link>
